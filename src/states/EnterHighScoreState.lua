...
-- Отдельный символы строки имени
local chars = {
    [1] = 65,
    [2] = 65,
    [3] = 65
...
-- символ который мы сейчас меняем
...
function EnterHighScoreState:update(dt)
    if love.keyboard.wasPressed('enter') or love.keyboard.wasPressed('return') then
        ...
        -- Проходим нозад таблицу рекордов до нужного счета, сдвигая баллы
        ...
        love.filesystem.write('breakout2.lst', scoresStr)
...
function EnterHighScoreState:render()
    ...
    -- визуализируем три симвала имени
